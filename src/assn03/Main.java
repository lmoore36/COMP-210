...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Test task 4
        list.reverse();
        System.out.println("Task 4: list after reversing elements = " + list.toString());
        ...
        System.out.println("Task 5: list 1 before merging = " + list6.toString());
        System.out.println("Task 5: list 2 before merging = " + list5.toString());

        list6.merge(list5);

        System.out.println("Task 5: list 1 after merging = " + list6.toString());
